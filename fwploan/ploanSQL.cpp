...
"   @now int)"
"  AS"
" update bas001 set data_yyymmdd = (case when data_yyymmdd = '' then NULL else data_yyymmdd end)"
" where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn;"
" update dam103 set ck_date    = (case when ck_date    = '' then NULL else ck_date    end)"
" where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn;"
" update dam203 set beg_date   = (case when beg_date   = '' then NULL else beg_date   end)"
" where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn;"
" update krm021 set card_brand = (case when card_brand = '' then NULL else card_brand end),"
...
" where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn;"
" update krm023 set issue      = (case when issue      = '' then NULL else issue      end),"
"                   issue_name = (case when issue_name = '' then NULL else issue_name end),"
"                   limit      = (case when limit      = '' then NULL else limit      end),"
...
" where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn;"
" update stm001 set bank_code  = (case when bank_code  = '' then NULL else bank_code  end),"
...
" where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn;"
" update bam085 set data_yyy      = (case when data_yyy      = '' then NULL else data_yyy      end),"
...
" select case_sn, idn, dac_sn, ever_delinquent, data_yyymmdd"
"  into #bas001_dedup"
"  from bas001"
"  where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn"
"  group by case_sn, idn, dac_sn, ever_delinquent, data_yyymmdd"
" select case_sn, idn, dac_sn, ck_date, issue_bank, bank_name, accnt_no, ck_type, check_no, amt, cancel_date, company_bounce, resp_id, resp_name"
"  into #dam103_dedup"
"  from dam103"
"  where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn"
"  group by case_sn, idn, dac_sn, ck_date, issue_bank, bank_name, accnt_no, ck_type, check_no, amt, cancel_date, company_bounce, resp_id, resp_name"
" select case_sn, idn, dac_sn, beg_date, end_date, rsn, source, upd_date, relief, s_ban, s_ban_name"
"  into #dam203_dedup"
"  from dam203"
"  where case_sn = @case_sn and idn = @idn and dac_sn = @dac_sn"
"  group by case_sn, idn, dac_sn, beg_date, end_date, rsn, source, upd_date, relief, s_ban, s_ban_name"
...
/* Insert_Daco_Table */
"insert into #daco_v32_cal(case_sn, idn, dac_sn, now) values (:v0, :v1, :v2, :v3);",
...
"   );"
"  end "
" insert into dac_audit(case_sn, idn, dac_sn, inquiry_date, now, avail_flag, jas002_defect, krm021_hit, krm023_hit,"
"  max_bucket, fs044, cash_max_bucket, cash_utilization, ind001, fs002_1k_9m, fs008_12mplus, fs016_9m,"
"  fs040, fs062_1k_3m, fs101_9m, fs105_6m, ms106_3m, ms106_9m, ms106_12m, ms001_1k_12m, ms006_1k_3m,"
"  ms006_1k_6m, ms009_3m, ms009_6m, ms011_12m, ms011_3m, ms011_6m, ms011_9m, ms015_3m, ms110_12m,"
"  ms110_3m, ms110_9m, ms203_1k_3m, ms203_1k_6m, ms203_1k_9m, ms205_1k_3m, ms205_1k_6m, mt006_1k_43,"
"  mt009_43, mt011_31, mt110_41, mt203_1k_42, mt205_1k_43, fs002_1k_9m_q, fs008_12mplus_r, fs105_6m_q,"
"  ms001_1k_12m_r, ms006_1k_6m_r, ms015_3m_q, mt006_1k_43_r, mt006_1k_43_r_tran, int015, mt009_43_q,"
"  mt110_41_r, mt203_1k_42_r, mt205_1k_43_r, fs002_1k_9m_q_tran, fs008_12mplus_r_tran, fs040_tran,"
"  fs062_1k_3m_z, fs101_9m_z, int015_tran, fs105_6m_q_t, ms001_1k_12m_r_t2, ms006_1k_6m_r_tran,"
"  ms015_3m_q_t2, mt009_43_q_t, mt011_31_z, mt110_41_r_t, mt203_1k_42_r_t, mt205_1k_43_r_tran,"
"  daco_score, fs025_12m, fs025_12m_z, fs029, fs029_t, fs029_t2, fs203_3m_1k, fs203_6m_1k, ft203_43_1k,"
"  ft203_43_1k_r, ft203_43_1k_r_t, ft203_43_1k_r_t3, ms119_12m, fs051, fs051_t2, ms024_3m, ms024_6m,"
"  ms024_9m, mt024_32, mt024_32_r, mt024_32_r_t, sex, sex_t, guarantor, segment, apr_group, rscore,"
"  twentile, pd)"
" select case_sn, idn, dac_sn, inquiry_date, now, avail_flag, jas002_defect, krm021_hit, krm023_hit,"
"  max_bucket, fs044, cash_max_bucket, cash_utilization, ind001, fs002_1k_9m, fs008_12mplus, fs016_9m,"
"  fs040, fs062_1k_3m, fs101_9m, fs105_6m, ms106_3m, ms106_9m, ms106_12m, ms001_1k_12m, ms006_1k_3m,"
"  ms006_1k_6m, ms009_3m, ms009_6m, ms011_12m, ms011_3m, ms011_6m, ms011_9m, ms015_3m, ms110_12m,"
"  ms110_3m, ms110_9m, ms203_1k_3m, ms203_1k_6m, ms203_1k_9m, ms205_1k_3m, ms205_1k_6m, mt006_1k_43,"
...
"   select idn, issue, start_mon_since, max(convert(decimal(16, 8), (case when limit='' then NULL else limit end)))"
"   from #krm021_dedup as a"
...
"   delete from #tmp1;"
"   insert into #tmp1 (idn, mon, v1)"
"    select idn, 3, max(payment_amt / convert(decimal(16, 8), (case when limit='' then NULL else limit end)))"
"    from #krm023_dedup"
...
"      and (start_mon_since < (@now - @i))"
"      and issue not in ('021', '081', '974')"
"      and convert(decimal(16, 8), (case when limit='' then NULL else limit end)) > 100"
"   set @i = @i + 1"
" end;"
" set @i = 3;"
" while @i <= 12"
...
" begin"
"   insert into #tmp (idn, mon, v1)"
"   select idn, @i, avg(convert(decimal (16, 8),(case when limit='' then NULL else limit end)))"
"   from #krm023_dedup"
