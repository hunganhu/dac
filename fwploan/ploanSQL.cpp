...
"   );"
"  end "
" insert into dac_audit41(case_sn, idn, dac_sn, inquiry_date, guarantor, sex, now, avail_flag, jas002_defect,"
...
" select case_sn, idn, dac_sn, inquiry_date, guarantor, sex, now, avail_flag, jas002_defect,"
"  krm021_hit, krm023_hit, max_bucket, fs044, cash_max_bucket, cash_utilization, ind001,"
"  ms056_6m_1k, ms056_6m_1k_tran, ms110_3m, ms110_6m, ms106_3m, ms106_6m, mt110_43,"
"  mt110_43_tran, fs002_6m_1k, fs002_6m_1k_q, fs002_6m_1k_q_tran, fs016_9m, fs101_9m,"
"  fs040, fs068, fs069, fs069_tran, int015_9m, int015_9m_tran, fs031, fs031_tran,"
...
" execute generate_ploan_score41 :v1;",
...
"/*****************************************************************************************"
"  * start making fs059"
"  * FS059	有延遲繳款額度數 (M1+) - Pay code in ('E','F')	KRM023"
"  *****************************************************************************************/"
" set @i = 3"
" while @i <= 6"
"    begin"
...
"    where a.idn = #daco_v41_cal.idn and mon = 6"
" /*****************************************************************************************"
"  * start making fs063_12m_1k"
"  * FS063	有延遲繳款額度數 (M2+) - Pay code in ('F')	KRM023"
"  *****************************************************************************************/"
" set @i = 12"
" while @i <= 12"
"    begin"
...
" /*****************************************************************************************"
"  * start making ms026_3m_"
"  * MS026	持有之信用卡最低額度	For line > 0 only	KRM023"
"  *****************************************************************************************/"
" delete from #tmp"
" set @i = 3"
" while @i <= 3"
...
"      and mon = 3"
" /*****************************************************************************************"
"  * start making ms024_3m_"
"  * MS024	持有之信用卡平均額度	For line > 0 only	KRM023"
"  *****************************************************************************************/"
" delete from #tmp"
" set @i = 3"
" while @i <= 3"
...
"      and mon = 3"
" /*****************************************************************************************"
"  * start making fs005_12m_1k"
"  * FS005	有延遲繳款月數 (M2+) - Pay code in ('F')"
"  *****************************************************************************************/"
" delete from #tmp"
" insert into #tmp (idn, mon, v1)"
"    select idn, 12, count(*)"
...
" /*****************************************************************************************"
"  * start making fs018"
"  * FS018	使用預借現金月數	Cash in ('Y')	KRM023	CashAdvance = 'Y'"
"  *****************************************************************************************/"
" delete from #tmp"
" delete from #tmp1"
" insert into #tmp1 (idn, mon, v1)"
...
"    where a.idn = #daco_v41_cal.idn"
" /*****************************************************************************************"
"  * start making ms119_12m"
"  * MS119	最低循環百分比 (Min of all line)	ABCD	KRM023"
"  *****************************************************************************************/"
" delete from #tmp;"
" set @i = 12;"
" while @i <= 12"
...
"    and mon = 12;"
" /*****************************************************************************************"
"  * start making ms120_9m"
"  * MS120	最低循環百分比 (Min of all line)	ABC	KRM023"
"  *****************************************************************************************/"
" delete from #tmp;"
" set @i = 9;"
" while @i <= 9"
...
""
" /*****************************************************************************************"
"  * start making ft102_42_r_tran3"
"  * FS102	持有之信用額度數 (Line > $100k)"
"  *****************************************************************************************/"
...
"         and a.mon = b.mon;"
" /*****************************************************************************************"
"  * start making ft212_43_1k_q_tran"
"  * FS212_1K	average # of delinquent lines opened less than 6 months	paycode CDEF"
"  *****************************************************************************************/"
" delete from #tmp"
" delete from #tmp1"
" set @i = 1"
...
" /*****************************************************************************************"
"  start making transformed variables:"
"    scorecard1: no guarantor, male"
"    Variable		transformation						description"
"    ------------------- ------------------------------------------------------- ----------------------------------------------------------------------"
"    dacoscore41									no need transform"
"    FT102_42_r_tran	FT102_42_r=FT102_42**0.5;"
"    			if FT102_42_r=. then FT102_42_r_tran=0;"
"    		    	else if FT102_42_r>2.625 then FT102_42_r_tran=2.625;"
"    		    	else FT102_42_r_tran=FT102_42_r;"
"    FS031_q_tran	FS031_q=FS031**2;"
"    			if  FS031_q=. then FS031_q_tran=0;"
"    		    	else if FS031_q>320 then FS031_q_tran=320;"
"    		    	else FS031_q_tran=FS031_q;"
"    gender_z		gender_z=(gender=0);					if gender=female then gender_z=1;"
"    FT212_43_1K_q_tran	FT212_43_1K_q=FT212_43_1K**2;"
"    			if FT212_43_1K_q=. then FT212_43_1K_q_tran=3;"
"    		    	else if FT212_43_1K_q>13 then FT212_43_1K_q_tran=13;"
"    		    	else FT212_43_1K_q_tran=FT212_43_1K_q;"
"    MS120_9M_r_tran	MS120_9M_r=MS120_9M**0.5;"
"    			if  MS120_9M_r>0.825 then MS120_9M_r_tran=0.825;"
"    		    	else MS120_9M_r_tran=MS120_9M_r;"
"    App_Last_Month_Bucket_tran	if App_Last_Month_Bucket=. then App_Last_Month_Bucket_tran=2;"
"    		    	else if App_Last_Month_Bucket>2 then App_Last_Month_Bucket_tran=2;"
"    		    	else App_Last_Month_Bucket_tran=App_Last_Month_Bucket;"
"    MS026_3M_r_tran	MS026_3M_r=MS026_3M**0.5;"
"    			if MS026_3M_r>12 then MS026_3M_r_tran=12;"
"    		    	else MS026_3M_r_tran=MS026_3M_r;"
"    FT059_1K_43_q_tran	FT059_1K_43_q=FT059_1K_43**2;"
"    			if FT059_1K_43_q>24.75 then FT059_1K_43_q_tran=24.75;"
"    		    	else FT059_1K_43_q_tran=FT059_1K_43_q;"
"    FS063_12M_1K_q	FS063_12M_1K_q=FS063_12M_1K**2;"
"    Formula:"
"    riskscore=	0.13362+"
"    		dacoscore41	            *	0.14544+"
...
"    		FT059_1K_43_q_tran	    *	0.01027+"
"    		FS063_12M_1K_q	            *	0.14215"
"    scorecard2: no guarantor, female"
"    Variable		transformation						description"
"    ------------------- ------------------------------------------------------- ----------------------------------------------------------------------"
"    dacoscore41									no need transformation"
"    MS024_3M_tran	if MS024_3M<55 then MS024_3M_tran=55;"
"    		    	else if MS024_3M>135 then MS024_3M_tran=135;"
"    		    	else MS024_3M_tran=MS024_3M;"
"    FT018_42_tran_q	if FT018_42<0 then FT018_42_tran=0;							do this tran in implementation"
"    		   	else FT018_42_tran=FT018_42;"
"    			FT018_42_tran_q=FT018_42_tran**2;"
"    RS017_r_tran	RS017_r=RS017**0.5;"
"    			if  RS017_r>9.75 then RS017_r_tran=9.75;"
"    		    	else RS017_r_tran=RS017_r;"
"    Formula:"
"    riskscore=	0.35637+"
"    		dacoscore41	*	0.1456+"
"    		MS024_3M_tran	*	-0.00143+"
"    		FT018_42_tran_q	*	0.02204+"
"    		RS017_r_tran	*	-0.02084"
"    scorecard3: with guarantor"
"    Variable		transformation						description"
"    ------------------- ------------------------------------------------------- ----------------------------------------------------------------------"
"    dacoscore41									no need transformation"
"    FS005_12M_1K_r	FS005_12M_1K_r=FS005_12M_1K**0.5;"
"    MS119_12M_r_tran	MS119_12M_r=MS119_12M**0.5;"
"    			if MS119_12M_r>0.32 then MS119_12M_r_tran=0.32;"
"    			else MS119_12M_r_tran=MS119_12M_r;"
"    Formula:"
"    if gender=0 then do;							if female then produce f_score1"
"       f_score1=	-0.00927+"
"                 	FS005_12M_1K_r		*	0.69960+"
"    	     		MS119_12M_r_tran	*	0.43594;"
"       end;"
"    else"
"       f_score1=0;"
"    riskscore=	0.01877	+"
