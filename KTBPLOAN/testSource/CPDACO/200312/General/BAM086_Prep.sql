...
go
--653
drop table y_BAM085_tmp_200312
go
create table y_BAM085_tmp_200312 
(IDN Char(6), 
...
declare @now int
set @now = 92 * 12 + 12
insert into y_BAM085_tmp_200312(IDN, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CONTRACT_AMT, LOAN_AMT, PASS_DUE_AMT, CO_LOAN, Bank_Code2, Bucket, Cycle)
select
