...
*****************************************************************************
**
** SOURCE FILE NAME: pdaco61SQL.cpp
**
** Description: PDACO V6.1 SQL code
**
****************************************************************************/
//---------------------------------------------------------------------------
#pragma hdrstop
...
char *SQLCommands[] = {
/* Get_AppInfo_Record */
"    SELECT	MSN, APR, APP_FEE, TOTAL_TERM, LOAN_AMOUNT, PB"
"    FROM	NPV_IN2"
"    WHERE MSN = :MSN AND LOAN_AMOUNT = :INPUT_TIME;",

/*Get_Prescreen_Result*/
" select JAS002_DEFECT, KRM021_HIT, KRM023_HIT, BAM086_HIT, MAX_BUCKET, FS044, FS059_3M_1K, FS059_12M_1K,"
" FS302, FS334, CARD_FORCE_STOP, FS334B_1M, CASH_UTILIZATION, IND001, REVOLVING_AMT,"
" MS605, CDEF_FLAG_1M, APR, TOTAL_TERM, REQUEST_AMT, MONTHLY_INCOME, MS606, APP_FEE, DEBT_FLAG, NOTE_FLAG "
" from #PDACO_V6_1"
" where MSN = :v0"
"   and INPUT_TIME = :v1",
...
" select KRM023_HIT, GRAY2_FLAG, CARD_FORCE_STOP, FS059_12M_1K, FS031"
" from #PDACO_V6_1"
" where MSN = :v0"
"   and INPUT_TIME = :v1",
...
" select LU_FLAG, FS021_9M"
" from #PDACO_V6_1"
" where MSN = :v0"
"   and INPUT_TIME = :v1",

/*Get_P4_Raw_Variables*/
" select MS604_R, RS017_R_TRAN, MS001_12M_1K_Q, FS3036_T5, FS031_TRAN4, FS546_9M_TRAN, INT053_6_Q, MS093, MS094B, MS105, WI004_9M"
" from #PDACO_V6_1"
" where MSN = :v0"
"   and INPUT_TIME = :v1",

/*Get_P5_Raw_Variables*/
" select FS016F_12M, RS017_R_TRAN2, MS074, FS205_3M_1K_Q_TRAN2, FS031_1M_Q_TRAN2, FS073B_12M_R, MS093, MS094B, MS105, WI003_9M_T"
" from #PDACO_V6_1"
" where MSN = :v0"
"   and INPUT_TIME = :v1",
...
" IF OBJECT_ID('tempdb..#BAM087_DEDUP') IS NOT NULL"
"    DROP TABLE #BAM087_DEDUP;"
...
"    DROP TABLE BAM086_BUCKET;"
" if exists (select * from dbo.sysobjects where id = object_id(N'BAM087_DEDUP') and OBJECTPROPERTY(id, N'IsUserTable') = 1) "
"    DROP TABLE BAM087_DEDUP;"
...
"    SELECT	MSN,IDN, INPUT_TIME, APPLICATION_AMOUNT, APPLICATION_RATE, APPLICATION_TERMS, APPLICATION_FEE, MONTHLY_INCOME"
"    FROM	APPLICANT"
"    WHERE MSN = :MSN AND INPUT_TIME = :INPUT_TIME;",

/* Insert_PDACO_V61 */
" INSERT INTO #PDACO_V6_1(MSN, IDN, INPUT_TIME, REQUEST_AMT, APR, TOTAL_TERM, APP_FEE, MONTHLY_INCOME)"
"    SELECT	MSN,IDN, INPUT_TIME, APPLICATION_AMOUNT, APPLICATION_RATE, APPLICATION_TERMS, APPLICATION_FEE, MONTHLY_INCOME"
"    FROM	APPLICANT"
"    WHERE MSN = :MSN AND INPUT_TIME = :INPUT_TIME;",
/* Dedup_KRM021 */
...
/* Dedup_BAM086 */
" INSERT INTO #BAM087_DEDUP(MSN, INQUIRY_DATE, IDN, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CONTRACT_AMT1, CONTRACT_AMT, LOAN_AMT, PASS_DUE_AMT, PAY_CODE_12, IS_KIND, PROJECT_CODE, CO_LOAN, UN_MARK, U_YYYMMDD, U_RATE, IB_MARK, IAB_BAN, IAB_NAME, CONTRACT_MARK, CONTRACT_CODE, CONTRACT_CODE1, CON_BAN, CON_NAME, ACT_Y_MARK, CONTRACT_AMT_Y, INPUT_TIME, CNT)"
"   SELECT MSN, INQUIRY_DATE, IDN, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CAST(CONTRACT_AMT1 AS INT), CAST(CONTRACT_AMT AS INT), CAST(LOAN_AMT AS INT), CAST(PASS_DUE_AMT AS INT), PAY_CODE_12, IS_KIND, PROJECT_CODE, CO_LOAN, UN_MARK, U_YYYMMDD, U_RATE, IB_MARK, IAB_BAN, IAB_NAME, CONTRACT_MARK, CONTRACT_CODE, CONTRACT_CODE1, CON_BAN, CON_NAME, ACT_Y_MARK, CAST(CONTRACT_AMT_Y AS INT), INPUT_TIME, COUNT(*)"
"   FROM BAM087"
"   WHERE MSN = :MSN AND INPUT_TIME = :INPUT_TIME"
"   GROUP BY MSN, INQUIRY_DATE, IDN, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CONTRACT_AMT1, CONTRACT_AMT, LOAN_AMT, PASS_DUE_AMT, PAY_CODE_12, IS_KIND, PROJECT_CODE, CO_LOAN, UN_MARK, U_YYYMMDD, U_RATE, IB_MARK, IAB_BAN, IAB_NAME, CONTRACT_MARK, CONTRACT_CODE, CONTRACT_CODE1, CON_BAN, CON_NAME, ACT_Y_MARK, CONTRACT_AMT_Y, INPUT_TIME; "
" IF @@ROWCOUNT > 0 "
"   BEGIN "
"      UPDATE #BAM087_DEDUP"
...
"      INSERT INTO #BAM086_DEDUP (MSN, IDN, INQUIRY_DATE, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CONTRACT_AMT, LOAN_AMT, PASS_DUE_AMT, PAY_CODE_12, CO_LOAN, INPUT_TIME)"
"        SELECT MSN, IDN, INQUIRY_DATE, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CONTRACT_AMT, LOAN_AMT, PASS_DUE_AMT, PAY_CODE_12, CO_LOAN, INPUT_TIME"
"        FROM #BAM087_DEDUP "
"        GROUP BY MSN, IDN, INQUIRY_DATE, DATA_YYY, DATA_MM, BANK_CODE, BANK_NAME, ACCOUNT_CODE, ACCOUNT_CODE2, PURPOSE_CODE, CONTRACT_AMT, LOAN_AMT, PASS_DUE_AMT, PAY_CODE_12, CO_LOAN, INPUT_TIME"
"   END "
" ELSE "
"   BEGIN "
...
" UPDATE #KRM021_DEDUP"
"    SET MSN      = (CASE WHEN LTRIM(MSN)              = '' THEN NULL ELSE MSN END),"
"        INQUIRY_DATE = (CASE WHEN LTRIM(INQUIRY_DATE) = '' THEN NULL ELSE INQUIRY_DATE END),"
"        IDN          = (CASE WHEN LTRIM(IDN)          = '' THEN NULL ELSE IDN END),"
"        CARD_BRAND   = (CASE WHEN LTRIM(CARD_BRAND)   = '' THEN NULL ELSE CARD_BRAND END),"
...
"        START_DATE   = (CASE WHEN LTRIM(START_DATE)   = '' THEN NULL ELSE START_DATE END),"
"        STOP_DATE    = (CASE WHEN LTRIM(STOP_DATE)    = '' THEN NULL ELSE STOP_DATE  END),"
"        STOP_CODE    = (CASE WHEN LTRIM(STOP_CODE)    = '' THEN NULL ELSE STOP_CODE  END),"
"        AB_CODE      = (CASE WHEN LTRIM(AB_CODE)      = '' THEN NULL ELSE AB_CODE    END),"
"        M_S          = (CASE WHEN LTRIM(M_S)          = '' THEN NULL ELSE M_S        END),"
"        LIMIT        = (CASE WHEN LTRIM(LIMIT)        = '' THEN NULL ELSE LIMIT      END);"
" UPDATE #KRM023_DEDUP"
"   SET MSN      = (CASE WHEN LTRIM(MSN) =      '' THEN NULL ELSE MSN END),"
"       INQUIRY_DATE = (CASE WHEN LTRIM(INQUIRY_DATE) = '' THEN NULL ELSE INQUIRY_DATE END),"
"       IDN          = (CASE WHEN LTRIM(IDN) =          '' THEN NULL ELSE IDN END),"
"       YRMON        = (CASE WHEN LTRIM(YRMON) =        '' THEN NULL ELSE YRMON END),"
"       ISSUE        = (CASE WHEN LTRIM(ISSUE) =        '' THEN NULL ELSE ISSUE END),"
"       ISSUE_NAME   = (CASE WHEN LTRIM(ISSUE_NAME) =   '' THEN NULL ELSE ISSUE_NAME END),"
"       KR_CODE      = (CASE WHEN LTRIM(KR_CODE) =      '' THEN NULL ELSE KR_CODE END),"
"       LIMIT        = (CASE WHEN LTRIM(LIMIT) =        '' THEN NULL ELSE LIMIT END),"
"       PAYMENT      = (CASE WHEN LTRIM(PAYMENT) =      '' THEN NULL ELSE PAYMENT END),"
"       CASH         = (CASE WHEN LTRIM(CASH) =         '' THEN NULL ELSE CASH END),"
"       PAY_CODE     = (CASE WHEN LTRIM(PAY_CODE) =     '' THEN NULL ELSE PAY_CODE END);"
" UPDATE #STM007_DEDUP"
"   SET MSN     = (CASE WHEN LTRIM(MSN)      = '' THEN NULL ELSE MSN END),"
"       INQUIRY_DATE = (CASE WHEN LTRIM(INQUIRY_DATE) = '' THEN NULL ELSE INQUIRY_DATE END),"
"       IDN          = (CASE WHEN LTRIM(IDN)          = '' THEN NULL ELSE IDN END),"
"       BANK_CODE    = (CASE WHEN LTRIM(BANK_CODE)    = '' THEN NULL ELSE BANK_CODE  END),"
"       BANK_NAME    = (CASE WHEN LTRIM(BANK_NAME)    = '' THEN NULL ELSE BANK_NAME  END),"
"       QUERY_DATE   = (CASE WHEN LTRIM(QUERY_DATE)   = '' THEN NULL ELSE QUERY_DATE END),"
"       ITEM_LIST    = (CASE WHEN LTRIM(ITEM_LIST)    = '' THEN NULL ELSE ITEM_LIST  END);"
" UPDATE #BAM086_DEDUP"
"   SET MSN      = (CASE WHEN LTRIM(MSN)       = '' THEN NULL ELSE MSN END),"
"       INQUIRY_DATE  = (CASE WHEN LTRIM(INQUIRY_DATE)  = '' THEN NULL ELSE INQUIRY_DATE END),"
"       IDN           = (CASE WHEN LTRIM(IDN)           = '' THEN NULL ELSE IDN END),"
"       DATA_YYY      = (CASE WHEN LTRIM(DATA_YYY)      = '' THEN NULL ELSE DATA_YYY      END),"
"       DATA_MM       = (CASE WHEN LTRIM(DATA_MM)       = '' THEN NULL ELSE DATA_MM       END),"
"       BANK_CODE     = (CASE WHEN LTRIM(BANK_CODE)     = '' THEN NULL ELSE BANK_CODE     END),"
"       BANK_NAME     = (CASE WHEN LTRIM(BANK_NAME)     = '' THEN NULL ELSE BANK_NAME     END),"
"       ACCOUNT_CODE  = (CASE WHEN LTRIM(ACCOUNT_CODE)  = '' THEN NULL ELSE ACCOUNT_CODE  END),"
"       ACCOUNT_CODE2 = (CASE WHEN LTRIM(ACCOUNT_CODE2) = '' THEN NULL ELSE ACCOUNT_CODE2 END),"
"       PURPOSE_CODE  = (CASE WHEN LTRIM(PURPOSE_CODE)  = '' THEN NULL ELSE PURPOSE_CODE  END),"
"       PAY_CODE_12   = (CASE WHEN LTRIM(PAY_CODE_12)   = '' THEN NULL ELSE PAY_CODE_12   END),"
"       CO_LOAN       = (CASE WHEN LTRIM(CO_LOAN)       = '' THEN NULL ELSE CO_LOAN       END);"
" UPDATE #KRM037_DEDUP"
...
"   FROM #TMP AS A"
"   WHERE A.IDN = #PDACO_V6_1.IDN;"
" /*----Number of credit lines with \EF_1K\ Delinquent in past 3 months ----*/"
" UPDATE #PDACO_V6_1"
...
"                    FROM #KRM023_DEDUP"
"                    WHERE INQUIRY_MON-1 - MON_SINCE <= 3"
"                      AND BUCKET_EF_1K > 0"
"                      AND IDN = #PDACO_V6_1.IDN)"
"    WHERE EXISTS (SELECT *"
"                    FROM #KRM023_DEDUP"
...
" MSN, INPUT_TIME, IDN, INQUIRY_DATE, NOW, REQUEST_AMT, APR, TOTAL_TERM, LOAN_AMT, "
" FSC_AMT, MONTHLY_INCOME, SCORECARD, PB, SCREEN_CODE, SCREEN_MSG, AVAIL_FLAG, "
" JAS002_DEFECT, KRM021_HIT, KRM023_HIT, BAM086_HIT, GRAY2_FLAG, MAX_BUCKET, FS044, "
" FS302, FS334, CARD_FORCE_STOP, CASH_MAX_BUCKET, CASH_UTILIZATION, "
" IND001, CARD_REV_BAL, MS105, REVOLVING_AMT, DEBT_FLAG, NOTE_FLAG, P0_SCORE, FS302_FG, P2_SCORE, "
" FS016C_9M_T1, LN001_9M, LN001_9M_T2, P3_SCORE, SECURE_FLAG, UNSECURE_FLAG, LU_FLAG, "
" P4_SCORE, RS017_R_TRAN, MS604_R, MS001_12M_1K_Q, FS061_6M_1K, FS018_12M_Z, FS309_Z, "
" INT053_6, INT053_6_Q, LN004_9M, LN004_9M_Q, FS546_9M_TRAN, FS3036_T5, FS031_TRAN4, "
" P5_SCORE, RS017_R, RS017_R_TRAN2, MS074_T2, MS074_T3, FS205_3M_1K_Q, "
" FS205_3M_1K_Q_TRAN2, WI003_9M_T, LN003_9M_T, FS031_1M_Q, FS031_1M_Q_TRAN2, "
" FS073B_12M_R, PDACO_TWEN, MS093, MS094B, AMORTIZATION_RATE, MONTHLY_PAYMENT, "
" MS101, FS031, FS031_1M, RS017, STOP_CODE_FLAG, FS036, FS040, MS063, MS074, FS309, "
" FS334B_1M, FS546_9M, FS314B, APP_MAX_BUCKET, CDEF_FLAG_1M, FS002_3M_1K, FS014_6M, "
" FS016C_9M, FS016F_12M, FS018_12M, FS021_9M, FS059_12M_1K, FS059_3M_1K, FS073B_12M, "
" FS101_6M, FS205_3M_1K, MS001_12M_1K, MS118_9M, MS601, MS604, MS605, MS606, "
" WI001_9M, WI003_9M, WI004_9M, RSCORE) "
"   SELECT "
" MSN, INPUT_TIME, IDN, INQUIRY_DATE, NOW, REQUEST_AMT, APR, TOTAL_TERM, LOAN_AMT, "
" FSC_AMT, MONTHLY_INCOME, SCORECARD, PB, SCREEN_CODE, SCREEN_MSG, AVAIL_FLAG, "
" JAS002_DEFECT, KRM021_HIT, KRM023_HIT, BAM086_HIT, GRAY2_FLAG, MAX_BUCKET, FS044, "
...
/* Store_Result */
" INSERT INTO RESULT (MSN, INPUT_TIME, "
"   APPROVED_AMOUNT, PB, NPV, SUGGESTION, SUGGESTION_CODE, "
"   UNSECURED_BALANCE, APPROVED_AMOUNT_FSC, SPECIAL_NOTE, "
"   UNSECURED_BALANCE_DAC, VERSION, MODULE_CODE) "
" VALUES(:idno, :input_time, :approved_amount, :pb, :npv, "
