...
DROP TABLE JAS002_VAR_200312
GO

CREATE TABLE TMP (IDN CHAR(6), MON INT, V1 INT)
GO

CREATE TABLE JAS002_VAR_200312
(
IDN CHAR(6), 
...
INSERT INTO JAS002_VAR_200312(IDN)
SELECT IDN FROM MASTER_200312_1
GO

UPDATE JAS002_VAR_200312
SET
...
SET
JAS002_B_3M = V1
FROM TMP AS A INNER JOIN JAS002_VAR_200312 AS B
ON A.IDN = B.IDN AND
   Mon = 3
