...
DROP TABLE FS3xx_200402
GO

Create table FS3xx_200402
(IDN Char(6), 
...
FS307_3M = V1
FROM FS_TMP AS A
WHERE A.IDN = FS3xx_200402.IDN AND
      MON = 3
GO
