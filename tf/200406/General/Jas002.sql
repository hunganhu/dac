...
DROP TABLE JAS002_VAR_200406
GO

CREATE TABLE TMP (IDN CHAR(6), MON INT, V1 INT)
GO

CREATE TABLE JAS002_VAR_200406
(
IDN CHAR(6), 
...
INSERT INTO JAS002_VAR_200406(IDN)
SELECT IDN FROM MASTER_200406_1
GO

UPDATE JAS002_VAR_200406
SET
...
SET
JAS002_B_3M = V1
FROM TMP AS A INNER JOIN JAS002_VAR_200406 AS B
ON A.IDN = B.IDN AND
   Mon = 3
