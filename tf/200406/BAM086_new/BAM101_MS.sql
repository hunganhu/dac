USE TF_KHJ
GO
DROP TABLE BAM101_MS_200406
GO

CREATE TABLE BAM101_MS_200406 
(IDN Char(6),
...
INSERT INTO BAM101_MS_200406(IDN)
SELECT DISTINCT IDN
FROM BAM101_200406
GO

UPDATE BAM101_MS_200406
SET
...
SET
MS405_3M = V1
FROM MS_TMP1 AS A INNER JOIN BAM101_MS_200406 AS B
ON A.IDN = B.IDN AND
   A.MON = 3
