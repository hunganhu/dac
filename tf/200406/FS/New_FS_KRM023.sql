...
drop table FS1xx_200406
GO

CREATE TABLE FS1xx_200406
(IDN Char(6),
...
FS101_3M = V1
FROM FS_TMP1 AS A
WHERE A.IDN = FS1xx_200406.IDN AND Mon=3

UPDATE FS1xx_200406
SET
FS101_6M = V1
FROM FS_TMP1 AS A
WHERE A.IDN = FS1xx_200406.IDN AND Mon=6

UPDATE FS1xx_200406
SET
FS101_9M = V1
FROM FS_TMP1 AS A
WHERE A.IDN = FS1xx_200406.IDN AND Mon=9

UPDATE FS1xx_200406
SET
FS101_12M = V1
FROM FS_TMP1 AS A
WHERE A.IDN = FS1xx_200406.IDN AND Mon=12
GO
