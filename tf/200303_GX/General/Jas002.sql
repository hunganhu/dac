...
DROP TABLE JAS002_VAR_200303
GO

CREATE TABLE TMP (IDN CHAR(6), MON INT, V1 INT)
GO

CREATE TABLE JAS002_VAR_200303
(
IDN CHAR(6), 
...
INSERT INTO JAS002_VAR_200303(IDN)
SELECT IDN FROM MASTER_200303_1
GO

UPDATE JAS002_VAR_200303
SET
...
SET
JAS002_B_3M = V1
FROM TMP AS A INNER JOIN JAS002_VAR_200303 AS B
ON A.IDN = B.IDN AND
   Mon = 3
