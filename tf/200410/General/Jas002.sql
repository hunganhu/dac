...
DROP TABLE JAS002_VAR_200410
GO

CREATE TABLE TMP (IDN CHAR(6), MON INT, V1 INT)
GO

CREATE TABLE JAS002_VAR_200410
(
IDN CHAR(6), 
...
INSERT INTO JAS002_VAR_200410(IDN)
SELECT IDN FROM MASTER_200410_1
GO

UPDATE JAS002_VAR_200410
SET
...
SET
JAS002_B_3M = V1
FROM TMP AS A INNER JOIN JAS002_VAR_200410 AS B
ON A.IDN = B.IDN AND
   Mon = 3
