...
DROP TABLE WI_MASTER_200410
GO

CREATE TABLE WI_MASTER_200410
(IDN CHAR(6),
 MS047 FLOAT,
 MS039 FLOAT,
 MS040 FLOAT,
...
MS048 = A.MS048,
MS050 = A.MS050
FROM MASTER_200410_1 AS A
WHERE WI_MASTER_200410.IDN = A.IDN
...
WI001_1 = A.V1
FROM WI_TMP1 AS A
WHERE A.IDN = WI_MASTER_200410.IDN AND
      @NOW - A.MON_SINCE = 1
