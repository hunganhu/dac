...
DROP TABLE BAM085_FS_200412
GO

CREATE TABLE BAM085_FS_200412
(IDN CHAR(6),
...
INSERT INTO BAM085_FS_200412(IDN)
SELECT DISTINCT IDN
FROM BAM085_200412
GO

UPDATE BAM085_FS_200412
SET
FS334=0,
FS315=0,
FS316=0,
...
FS334 = V1
FROM FS_TMP1 AS A
WHERE A.IDN = BAM085_FS_200412.IDN
GO
...
WHERE NOT EXISTS
(SELECT * FROM FS_TMP2
 WHERE y_BAM085_tmp_200412.IDN = FS_TMP2.IDN AND
       y_BAM085_tmp_200412.BANK_CODE2 = FS_TMP2.ISSUER) AND
      PURPOSE_CODE = '1' AND
      ((account_code2 is null) OR (account_code2 = '') OR (account_code = 'N')) AND
      ACCOUNT_CODE != 'K'
GROUP BY IDN  
...
FROM y_BAM085_tmp_200412 AS A INNER JOIN y_BAM085_tmp_200412 AS B
ON A.IDN = B.IDN AND
...
FS354_3M = V1
FROM FS_TMP AS A
WHERE A.IDN = BAM085_FS_200412.IDN AND
      A.MON = 10
...
BEGIN
 ...
 WHERE NOT EXISTS
 (SELECT * FROM FS_TMP2
   WHERE BAM085_200412.IDN = FS_TMP2.IDN AND
         BAM085_200412.BANK_CODE2 = FS_TMP2.ISSUER) AND
         PURPOSE_CODE = '1' AND
         ((account_code2 is null) OR (account_code2 = '') OR (account_code = 'N')) AND
         ACCOUNT_CODE != 'K' AND
         LEN(LTRIM(RTRIM(PAY_CODE_12))) + @now - 1 - cast(isnull(data_yyy, 0) as int) * 12 - cast(isnull(data_mm, 0) as int) = @i
