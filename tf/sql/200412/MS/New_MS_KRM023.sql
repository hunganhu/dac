...
DROP TABLE MS1xx_200412
GO

CREATE TABLE MS1xx_200412
(IDN Char(6), 
...
MS101_3M = V1
FROM MS_TMP AS A
WHERE A.IDN = MS1xx_200412.IDN AND Mon=3

UPDATE MS1xx_200412
SET
MS101_6M = V1
FROM MS_TMP AS A
WHERE A.IDN = MS1xx_200412.IDN AND Mon=6

UPDATE MS1xx_200412
SET
MS101_9M = V1
FROM MS_TMP AS A
WHERE A.IDN = MS1xx_200412.IDN AND Mon=9

UPDATE MS1xx_200412
SET
MS101_12M = V1
FROM MS_TMP AS A
WHERE A.IDN = MS1xx_200412.IDN AND Mon=12
GO
