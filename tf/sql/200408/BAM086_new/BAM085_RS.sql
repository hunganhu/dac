...
DROP TABLE BAM085_RS_200408
GO

CREATE TABLE BAM085_RS_200408
(IDN CHAR(6),
...
INSERT INTO BAM085_RS_200408(IDN)
SELECT DISTINCT IDN
FROM BAM085_200408
GO

UPDATE BAM085_RS_200408
SET
RS101=0,
RS102=0,
RS103=0,
...
RS101 = 13 - V1
FROM RS_TMP1 AS A
WHERE A.IDN = BAM085_RS_200408.IDN
GO
...
WHERE Bucket > 0 AND
      NOT EXISTS
(SELECT * FROM RS_TMP2
 WHERE y_BAM085_tmp_200408.IDN = RS_TMP2.IDN AND
       y_BAM085_tmp_200408.BANK_CODE2 = RS_TMP2.ISSUER) AND
      PURPOSE_CODE = '1' AND
      ((account_code2 is null) OR (account_code2 = '') OR (account_code2 = 'N')) AND
      ACCOUNT_CODE != 'K'
GROUP BY IDN  
