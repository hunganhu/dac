...
DROP TABLE JAS002_VAR_200408
GO

CREATE TABLE TMP (IDN CHAR(6), MON INT, V1 INT)
GO

CREATE TABLE JAS002_VAR_200408
(
IDN CHAR(6), 
...
INSERT INTO JAS002_VAR_200408(IDN)
SELECT IDN FROM MASTER_200408_1
GO

UPDATE JAS002_VAR_200408
SET
...
SET
JAS002_B_3M = V1
FROM TMP AS A INNER JOIN JAS002_VAR_200408 AS B
ON A.IDN = B.IDN AND
   Mon = 3
