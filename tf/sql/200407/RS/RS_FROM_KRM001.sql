...
/*----Prepare Open_Issuer table for RS_200407 variables 010, 018, 022, 024----*/
/*----This table is extended to the open date of the fiRS_200407t card of each peRS_200407on----*/
DECLARE @Now INT, @i INT, @j INT
SET @NOW = 93 * 12 + 7
DELETE FROM Open_Issuer
SET @j = @Now - (SELECT MIN(Start_Mon_Since) FROM KRM001_200407)
SET @i = 0
WHILE @i<= @j
BEGIN
