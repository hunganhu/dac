...
DROP TABLE BAM085_FS_200403
GO

CREATE TABLE BAM085_FS_200403
(IDN CHAR(6),
...
INSERT INTO BAM085_FS_200403(IDN)
SELECT DISTINCT IDN
FROM BAM085_200403
GO

UPDATE BAM085_FS_200403
SET
FS334=0,
FS315=0,
FS316=0,
...
FS334 = V1
FROM FS_TMP1 AS A
WHERE A.IDN = BAM085_FS_200403.IDN
GO
...
WHERE NOT EXISTS
(SELECT * FROM FS_TMP2
 WHERE y_BAM085_tmp_200403.IDN = FS_TMP2.IDN AND
       y_BAM085_tmp_200403.BANK_CODE2 = FS_TMP2.ISSUER) AND
      PURPOSE_CODE = '1' AND
      ((account_code2 is null) OR (account_code2 = '') OR (account_code = 'N')) AND
      ACCOUNT_CODE != 'K'
GROUP BY IDN  
...
FROM y_BAM085_tmp_200403 AS A INNER JOIN y_BAM085_tmp_200403 AS B
ON A.IDN = B.IDN AND
...
FS354_3M = V1
FROM FS_TMP AS A
WHERE A.IDN = BAM085_FS_200403.IDN AND
      A.MON = 10
