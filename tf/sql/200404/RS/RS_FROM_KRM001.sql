...
/*----Prepare Open_Issuer table for RS_200404 variables 010, 018, 022, 024----*/
/*----This table is extended to the open date of the fiRS_200404t card of each peRS_200404on----*/
DECLARE @Now INT, @i INT, @j INT
SET @NOW = 93 * 12 + 4
DELETE FROM Open_Issuer
SET @j = @Now - (SELECT MIN(Start_Mon_Since) FROM KRM001_200404)
SET @i = 0
WHILE @i<= @j
BEGIN
