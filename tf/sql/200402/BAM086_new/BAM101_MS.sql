USE TF_KHJ
GO
DROP TABLE BAM101_MS_200402
GO

CREATE TABLE BAM101_MS_200402 
(IDN Char(6),
...
INSERT INTO BAM101_MS_200402(IDN)
SELECT DISTINCT IDN
FROM BAM101_200402
GO

UPDATE BAM101_MS_200402
SET
...
SET
MS405_3M = V1
FROM MS_TMP1 AS A INNER JOIN BAM101_MS_200402 AS B
ON A.IDN = B.IDN AND
   A.MON = 3
