...
DROP TABLE JAS002_VAR_200405
GO

CREATE TABLE TMP (IDN CHAR(6), MON INT, V1 INT)
GO

CREATE TABLE JAS002_VAR_200405
(
IDN CHAR(6), 
...
INSERT INTO JAS002_VAR_200405(IDN)
SELECT IDN FROM MASTER_200405_1
GO

UPDATE JAS002_VAR_200405
SET
...
SET
JAS002_B_3M = V1
FROM TMP AS A INNER JOIN JAS002_VAR_200405 AS B
ON A.IDN = B.IDN AND
   Mon = 3
