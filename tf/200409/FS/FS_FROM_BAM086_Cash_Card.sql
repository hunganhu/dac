...
DROP TABLE FS3xx_200409
GO

Create table FS3xx_200409
(IDN Char(6), 
...
FS307_3M = V1
FROM FS_TMP AS A
WHERE A.IDN = FS3xx_200409.IDN AND
      MON = 3
GO
