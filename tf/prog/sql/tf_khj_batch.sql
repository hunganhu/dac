...
/* load application data */
  ...
  insert into tf_ploan_cal (app_sn, app_date, product_type, edu, gender, secretive, marriage_status)
     select app_sn, data_time,product_type, edu, gender, secretive, marriage_status
     from app_info

  update tf_ploan_cal
     set loan_del_number_6m = a.v1
     from (select app_sn, isnull(loan1_payment6,0) + isnull(loan2_payment6,0) + isnull(loan3_payment6,0)
                        ...
                        + isnull(loan1_payment1,0) + isnull(loan2_payment1,0) + isnull(loan3_payment1,0) as v1
           from ts  
           ) as a
...
/* select approciated model: demo, bam085_1,bam085_2, full jcic */
 ...
 update tf_ploan_cal set score_card = null
