...
"Execute TF_prepare_jcic_data :v0;",
...
" if exists (select * from dbo.sysobjects where id = object_id(N'[TF_ploan_model]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)"
" drop procedure TF_ploan_model;",

/* Exec_Procedure_TF_ploan_model */
" execute TF_ploan_model;",
...
" if exists (select * from dbo.sysobjects where id = object_id(N'[TF_loan_prescreen]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)"
" drop procedure TF_loan_prescreen;",

/* Exec_Procedure_TF_loan_prescreen */
" execute TF_loan_prescreen;",
...
" if exists (select * from dbo.sysobjects where id = object_id(N'[TF_demographic_model]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)"
" drop procedure TF_demographic_model;",

/* Exec_Procedure_Generate_Ploan_Score */
" execute TF_demographic_model;",
...
" if exists (select * from dbo.sysobjects where id = object_id(N'[TF_BAM_no_payment]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)"
" drop procedure TF_BAM_no_payment;",

/* Exec_Procedure_TF_BAM_no_payment */
" execute TF_BAM_no_payment;",
...
" if exists (select * from dbo.sysobjects where id = object_id(N'[TF_BAM_with_payment]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)"
" drop procedure TF_BAM_with_payment;",

/* Exec_Procedure_TF_BAM_with_payment */
" execute TF_BAM_with_payment;",
