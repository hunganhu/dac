...
"      and card_brand is not null and card_brand <> ''"
...
"    from bam082"
"    where app_sn = @app_sn and data_time = @data_time"
"      and data_yyy is not null and data_yyy <> ''"
...
" update #krm001_dedup set card_brand = (case when card_brand = '' then NULL else card_brand end),"
...
"    from jas002"
"    where app_sn = @app_sn and data_time = @data_time"
"      and (delinquent_date is not null and delinquent_date <> '');"
" insert into #jas002_t (app_sn, data_time, reason, date_happen)"
"    select app_sn, data_time, 'B', bad_check_date"
"    from jas002"
"    where app_sn = @app_sn and data_time = @data_time"
"      and (bad_check_date is not null and bad_check_date <> '');"
" insert into #jas002_t (app_sn, data_time, reason, date_happen)"
"    select app_sn, data_time, 'R', reject_date"
"    from jas002"
"    where app_sn = @app_sn and data_time = @data_time"
"      and (reject_date is not null and reject_date <> '');"
" insert into #jas002_t (app_sn, data_time, reason, date_happen)"
"    select app_sn, data_time, 'S', stop_card_date"
"    from jas002"
"    where app_sn = @app_sn and data_time = @data_time"
"      and (stop_card_date is not null and stop_card_date <> '');"
...
"               	end)"
" update #krm023_dedup"
"    set yrmon = (case when left(yrmon,1) not in ('1', '0', '*') then '0' + ltrim(rtrim(yrmon))"
"    	              else yrmon"
"    	         end);"
" update #krm023_dedup"
...
"               	end)"
" update #stm001_dedup"
"    set query_date = (case when left(query_date,1) not in ('1', '0', '*') then '0' + ltrim(rtrim(query_date))"
" 		           else query_date"
" 		      end);"
" update #stm001_dedup"
...
" /* providing contract_amt <> 0       20050903 0.98 to 0.95                               */"
" /*****************************************************************************************/"
" delete from #tmp"
" insert into #tmp(app_sn, v1)"
"    select app_sn, count(*)"
...
"      and a.mon = 3"
" /*****************************************************************************************/"
" /* FS313 動用比例超過96%筆數           20050903 0.96 to 0.95                             */"
" /*****************************************************************************************/"
" delete from #tmp"
" insert into #tmp(app_sn, v1)"
"    select app_sn, count(*)"
...
"      and a.mon = 3"
" /*****************************************************************************************/"
" /* FS314 動用比例超過100%筆數   20050903 100% to 95%                                     */"
" /*****************************************************************************************/"
" update #tf_ploan_cal"
"    set fs314 = v1"
