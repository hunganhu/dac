...
void __fastcall TfrmLogin::btnLoginClick(TObject *Sender)
{
  ...
  connection_string += "Password=dac_usr1;";
  connection_string += "Persist Security Info=True;User ID=dac_usr1;";
  connection_string += "Initial Catalog=TNB_CC;Data Source=DAC-DB1";
