...
COMMENT ON COLUMN AAS001.IDN 		IS '申請人身分證字號';
COMMENT ON COLUMN AAS001.ID 		IS '身分證字號';
...
COMMENT ON COLUMN APS001.IDN 		IS '申請人身分證字號';
...
COMMENT ON COLUMN BAS001.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN BAM086.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN BAM087.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN BAM302.IDN 		IS '申請人身分證字號';
...
COMMENT ON COLUMN BAM302.M_ID		IS '主債務人身分證字號';
...
COMMENT ON TABLE BAM303	IS '授信保證資料(B31之從債務資料) (多筆 B31-B33)';
COMMENT ON COLUMN BAM303.CASE_SN	IS '申請編號';
COMMENT ON COLUMN BAM303.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN BAM303.M_ID	IS '主債務人身分證字號';
...
COMMENT ON COLUMN BAM304.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN BAM304.M_ID		IS '主債務人身分證字號';
...
COMMENT ON COLUMN DAM103.IDN 		IS '申請人身分證字號';
...
COMMENT ON COLUMN DAM103.RESP_ID 	IS '公司統編或負責人身分證字號';
...
COMMENT ON COLUMN DAM203.IDN 		IS '申請人身分證字號';
...
COMMENT ON COLUMN DAS006.IDN		IS '申請人身分證字號';
...
COMMENT ON COLUMN jas002.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN KRM001.IDN	 	IS '申請人身分證字號';
...
COMMENT ON COLUMN KRM023.IDN 		IS '申請人身分證字號';
...
COMMENT ON COLUMN KRM037.IDN 		IS '申請人身分證字號';
...
COMMENT ON COLUMN STM001.IDN		IS '申請人身分證字號';
...
COMMENT ON COLUMN STM007.IDN		IS '申請人身分證字號';
...
COMMENT ON COLUMN VAM102.IDN		IS '申請人身分證字號';
COMMENT ON COLUMN VAM102.inquiry_date	IS 'JCIC 資料查詢日期(yyy/mm/dd, yyy為民國年)';
COMMENT ON COLUMN VAM102.IDN_BAN	IS '統編/身分證字號';
...
COMMENT ON COLUMN app_info.Applicant_ID	IS '申請人身分證字號';
COMMENT ON COLUMN app_info.applicant_name	IS '申請人姓名';
COMMENT ON COLUMN app_info.Guarantor_ID	IS '保證人身分證字號';
...
COMMENT ON COLUMN app_info.CI_key	IS '業務員身分證字號';
...
COMMENT ON COLUMN app_info.errcode	IS '錯誤代碼';
