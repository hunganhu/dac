...
#ifndef InputNewMortgageH
#define InputNewMortgageH
//---------------------------------------------------------------------------
#include <Classes.hpp>
#include <Controls.hpp>
#include <StdCtrls.hpp>
...
//---------------------------------------------------------------------------
class TfrmRegularInput : public TForm
{
__published:	// IDE-managed Components
  ...
  TEdit *edtLandSerial;
  void __fastcall btnExit04Click(TObject *Sender);
...
public:		// User declarations
  __fastcall TfrmRegularInput(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TfrmRegularInput *frmRegularInput;
//---------------------------------------------------------------------------
#endif
