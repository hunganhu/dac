...
//       gav2 = query->FieldByName("GAV2")->AsInteger;
       ...
       if (head_region != region_name) {
           ...
           report_individual << "birthday,owner_name1,owner_id1,relationship1,land_num1,owner_name2,owner_id2,relationship2,land_num2,";
...
//       location2 = query->FieldByName("LOCATION2")->AsInteger;
       ...
       if (head_region != region_name) {
           ...
           report_individual << "birthday,app_amt,apr,period,app_fee,owner_name1,owner_id1,relationship1,land_num1,property1_status,gav1,nav1,";
